...
<body>
        ...
        <div class="col-md-8 main-content">
            ...
            <form action="" method="post">
                ...
                <div class="form-group top">
                    ...
                    <input type="text" name="cat_name" id="cat_name" class="form-control" value="<?php echo $category_name ;?>" required>
                </div>

                <div class="form-group top">
                    <label for="book_price">Book Price</label>
                    <input type="number" name="book_price" id="book_price" class="form-control" value="<?php echo $book_price; ?>" required>
                </div>

                <button type="submit" name="edit_book" class="btn btn-primary top">Update</button>
            </form>
        </div>
        <div class="col-md-2"></div>
    </div>
    ...
    if (isset($_POST['edit_book'])) {
        $query = "UPDATE books SET book_name='$_POST[book_name]',author_name='$_POST[author_name]',cat_name='$_POST[cat_name]',book_price= $_POST[book_price] WHERE book_id=$id";
        $query_run = mysqli_query($connection, $query);
        ?>
        <script>
