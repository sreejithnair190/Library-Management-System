...
<body>
    ...
    <div class="col-md-4"></div>
		<div class="col-md-4">
            ...
            <center>
            <a href="edit_profile.php"><button class="btn btn-primary top">Edit Profile</button></a>
            <a href="change_password.php"><button class="btn btn-primary top ms-5">Change Password</button></a>
            </center>
		</div>
		<div class="col-md-4"></div>
    </div>
