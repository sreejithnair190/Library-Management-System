                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-success">
                                <a href="edit_category.php?cid=<?php echo $row['cat_id'];?>" style="text-decoration: none; color: white;">
                                    Edit
                                </a>
                            </button>
                            <button class="btn btn-danger">
                                <a href="delete_category.php?cid=<?php echo $row['cat_id'];?>" style="text-decoration: none; color: white;">
                                    Delete
                                </a>
                            </button>
                        </td>
