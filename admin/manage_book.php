                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-success">
                                <a href="edit_book.php?bid=<?php echo $row['book_id'];?>" style="text-decoration: none; color: white;">
                                    Edit
                                </a>
                            </button>
                            <button class="btn btn-danger">
                                <a href="delete_book.php?bid=<?php echo $row['book_id'];?>" style="text-decoration: none; color: white;">
                                    Delete
                                </a>
                            </button>
                        </td>
