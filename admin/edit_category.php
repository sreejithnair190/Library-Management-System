...
<body>
        ...
        <div class="col-md-8 main-content">
            ...
            <form action="" method="post">
                <div class="form-group top">
                    ...
                    <input type="text" name="cat_name" id="cat_name" class="form-control" value="<?php echo $cat_name; ?>" required>
                </div>

                <button type="submit" name="edit_category" class="btn btn-primary top">Update</button>
            </form>
        </div>
        <div class="col-md-2"></div>
    </div>
    ...
    if (isset($_POST['edit_category'])) {
        $query = "UPDATE category SET cat_name='$_POST[cat_name]' WHERE cat_id=$id";
        $query_run = mysqli_query($connection, $query);
        ?>
        <script>
